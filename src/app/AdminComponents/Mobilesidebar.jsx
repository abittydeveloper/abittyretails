...
const Mobilesidebar = () => {
  ...
  return (
    <aside className={`bg-slate-900   overflow-auto w-60   h-screen`}>
                <div className={`text-white mt-5 flex justify-start flex-col px-2 `}>
                    ...
                    <div className="flex flex-col  mt-1">
                        ...
                        <ul className={`flex w-full flex-col  ${showproduct ? "h-full" : "hidden h-0"}`} >
                            ...
                            <li className="py-2"><Link href="" className='ml-12'>Tags</Link></li>
                            <li className="py-2"><Link href="" className='ml-12'>Brands</Link></li>
                        </ul>
                    </div>
