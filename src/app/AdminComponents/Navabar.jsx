  ...
  return (
    <header className="w-full flex items-center borderfornav" style={{ justifyContent: "space-between", padding: "10px" }}>
      ...
      <HiMiniBars3 className='mr-2 md:hidden' style={{ fontSize: "25px" }} onClick={changevalue}/>
        <img src='https://i.postimg.cc/XYDxVftd/Whats-App-Image-2023-11-25-at-8-30-15-PM.jpg' style={{ width: "100px" }} />
      </div>
      ...
      <div className="flex items-center justify-center gap-4">
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/59/User-avatar.svg/2048px-User-avatar.svg.png" style={{ width: "30px", height: "30px", borderRadius: "50%" }} className="border-cyan-950" />
