...
const tagdata = [

  {
    ...
    "tagid": "12345",
    "tagname": "Female",
    "tagimage": "Femaletagimage"
  },
  {
    "id": 2,
    "tagid": "67890",
    "tagname": "kids",
    "tagimage": "kidstagimage"
  },
  {
    "id": 3,
    "tagid": "54321",
    "tagname": "T-shirts",
    "tagimage": "t-shirttagimage"
  },
  {
    "id": 4,
    "tagid": "98765",
    "tagname": "Jewels",
    "tagimage": "jewelstagimage"
  },
  ...
  return (
    <>
      <div className='sidebarleft overflow-auto p-9 w-full'>
        <div className="text-2xl ">Add Tags</div>
        <div className="w-full flex justify-end ">
          <div className='flex items-center w-fit justify-center gap-2 px-3 py-2 bg-slate-800 text-white hover:bg-slate-700 rounded-lg cursor-pointer' onClick={handleClickOpen('paper')}><RiFolderAddLine style={{ fontSize: "20px" }} /> <span>Add Tags</span></div>
        </div>
          ...
          <table className="w-full text-sm text-left rtl:text-right text-gray-500">
            <thead className='text-xs text-gray-700 uppercase bg-gray-50 '>
              <tr>
                ...
                <th scope="col" className='px-6 py-4'>Tag Id</th>
                <th scope="col" className='px-6 py-4'>Tag banner</th>
                <th scope="col" className='px-6 py-4'>Tag name</th>
